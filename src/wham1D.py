...
plt.xticks(size=18)
plt.yticks(size=18)
fig.set_xlabel('Distance in Å', size=18)
...
plt.yticks(size=18)
fig.set_xlabel('Distance in Å', size=18)
fig.set_ylabel('Free-energies in eV', size=18)
...
fig.set_xlabel('Distance to water COM in Å', size=18)
fig.set_ylabel('Free-energy in kcal/mol', size=18)
